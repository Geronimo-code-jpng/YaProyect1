...
import { fetchCategorias, fetchProductoById } from "../../lib/catalogApi";
...
export default function ProductModal({
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.imageFile) {
      (productData as any).imageFile = formData.imageFile;
    }
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  <button
                    ...
                    onClick={() =>
                      setFormOverrides((prev) => ({
                        ...prev,
                        oferta_express: !formData.oferta_express,
                      }))
                    }
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  <button
                    ...
                    onClick={() =>
                      setFormOverrides((prev) => ({
                        ...prev,
                        solo_bulto: !formData.solo_bulto,
                      }))
                    }
                    className={`w-14 h-7 rounded-full transition relative ${
