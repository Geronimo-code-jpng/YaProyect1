            ...
            <nav className="hidden md:flex items-center text-sm font-bold mr-auto gap-2">
              ...
              >
                ...
                {categoriesOpen && categories.length > 0 && (
                  <div className="absolute top-full left-0 mt-1 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 min-w-[220px] z-50">
                    <Link
                      to="/productos"
